    ...
    <div className="min-h-screen  mx-auto py-2 bg-midNight">
      ...
      <div className="w-1/3 mt-40 mx-auto border p-6 rounded-xl   ">
        <form onSubmit={(e) => submitForm(e)}>
          ...
          <div className="p-3">
            <div className="mb-1">
              <label htmlFor="pass" className="text-white text-2xl">
                Password:
              </label>
            </div>
            <input
          ...
          <div className="text-center m-2">
            <p className="text-white mb-4 m-3">
            ...
            <button
              type="submit"
              className="bg-green hover:bg-green-500 text-midNight font-bold py-2 px-4 rounded"
            >
              Lets go in there
            </button>
          </div>
